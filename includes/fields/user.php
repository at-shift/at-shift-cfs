        ...
        <tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
            <td class="label">
                ...
                <div class="cfs_tooltip">?
                    <div class="tooltip_inner"><?php esc_html_e( 'Minimum sets the fewest users that can be selected. Maximum sets the most users that can be selected.', 'atshift-fields-maintenance-for-custom-field-suite' ); ?></div>
                </div>
            </td>
            <td>
